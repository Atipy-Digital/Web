...
export const PostInfo = ({ date, tags }: Props) => {
  return (
    <Box className='max-w-5xl'>
      <div className='flex items-center flex-wrap-reverse px-0 md:px-fluid gap-2'>
        ...
        <div className='flex-shrink-0 flex items-center gap-2 lg:gap-3 text-grey-110 dark:text-grey-100'>
