...
export const Contact = ({ data }: Props) => {
  ...
  return (
    ...
    >
      <div
        className='tl flex flex-col md:flex-row justify-center md:justify-between lg:justify-center items-center sm:px-fluid sm:py-fluid relative w-full lg:gap-x-16 xl:gap-x-20 2xl:gap-x-24'>
