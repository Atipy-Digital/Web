...
export const TeamCard = ({image, badge, linkedin, name, skills, decorativeOrInformative}: Props) => {
	return (
		<article
			className='col-span-1 flex-grow w-full h-full rounded-[10px] p-4 flex flex-col bg-white shadow-project-card dark:bg-background dark:border-2 dark:border-white dark:shadow-none max-w-[450px] m-auto'>
