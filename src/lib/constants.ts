...
export const MAILCHIMP_API_KEY = process.env.NEXT_PUBLIC_MAILCHIMP_API_KEY as string
export const MAILCHIMP_API_SERVER = process.env.NEXT_PUBLIC_MAILCHIMP_API_SERVER as string
export const AUDIENCE_DESIGN_ID = process.env.NEXT_PUBLIC_AUDIENCE_DESIGN_ID as string
export const AUDIENCE_DIGITAL_ID = process.env.NEXT_PUBLIC_AUDIENCE_DIGITAL_ID as string
export const AUDIENCE_ENGINEERING_ID = process.env.NEXT_PUBLIC_AUDIENCE_ENGINEERING_ID as string

export const URL_NETLIFY_SUBSCRIBE = process.env.NEXT_PUBLIC_URL_NETLIFY_SUBSCRIBE as string
