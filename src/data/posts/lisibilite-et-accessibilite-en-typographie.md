---
metadata:
  title: Lisibilité et accessibilité en typographie
  description: Il existe une grande diversité des besoins, et ce qui sera une aide
    pour certains publics constituera une gêne pour d'autres.
  keywords:
    - keyword: typographie
    - keyword: lisibilité
title: "Lisibilité et accessibilité en typographie : les enseignements du projet
  Luciole"
date: 2026-01-30T14:15:25.894Z
timeToRead: 10 à 15 minutes
post_tags:
  - Design
...
post_sections:
  - inverseCol: false
    col1:
      ...
      text:
        content: >-
          Le projet Luciole a débuté il y a une dizaine d'années, pour répondre
          au besoin d’améliorer l’accessibilité à la lecture pour les personnes
          déficientes visuelles en France. Rapidement adopté par une vingtaine
          d'éditeurs et des centaines de professionnels, le projet a évolué ces
          dernières années vers une nouvelle dimension de formation et
          sensibilisation des professionnels aux enjeux de lisibilité et
          d'accessibilité du texte, ce que nous souhaitions partager dans cet
          article.


          A﻿rticlé rédigé par Jonathan Fabreguettes
    col2:
      reverseMobile: false
      image:
        decorativeOrInformative: false
  ...
  - inverseCol: false
    col1:
      ...
      image:
        decorativeOrInformative: false
        url: /media/typographie-lisibilite-crite-res-atipy-accessibilite-.png
        alt: Complexité, originalité, Différentiation, taille, épaisseur, capitales,
          interlettrage, Interlignage, lignes, contrastes, Hiérarchisation,
          opacité.
    col2:
      reverseMobile: false
      image:
  ...
  - inverseCol: false
    col1:
      ...
      image:
        decorativeOrInformative: false
        url: /media/typographie-lisibilite-criteres-specifiques-atipy.png
        alt: Linéale, Contreformes, épaisseur, espacement, Proportions, modulation,
          Diacritiques, italiques, Agrandissement, blancheur, brillance,
          couleur.
    col2:
      reverseMobile: false
      image:
  ...
  - inverseCol: false
    col1:
      ...
      text:
        content: >-
          Il convient de rappeler que ces critères s'additionnent aux critères
          précédents, et ne sauraient suffire à garantir à eux seuls une bonne
          accessibilité à un lecteur malvoyant. 
  ...
  - inverseCol: false
    col1:
      ...
      image:
        decorativeOrInformative: false
        url: /media/liste-accessibilite-lisibilite-.png
        alt: 1 - Généralisables, 2 Spécifiques au domaine, 3 Presque généralisables, 4
          Principaux handicaps, 5 Modalités d'écriture , 6 Structuration du
          contenu
    col2:
      reverseMobile: false
      image:
  ...
  - inverseCol: false
    col1:
      ...
      image:
        decorativeOrInformative: false
      text:
        content: "L'accessibilité universelle est, comme nous l'avons expliqué, un idéal
          inatteignable pour le texte : il est important de rappeler, et de
          revendiquer, la spécificité des besoins de chacun. Ce constat rend
          d'autant plus nécessaire l'adoption d'une démarche construite et
          argumentée. Les bonnes pratiques d'accès au texte demeurent encore
          largement méconnues et trop peu mises en œuvre, alors même qu'elles
          pourraient parfois l'être de façon simple, rapide et peu
          contraignante, dans l'intérêt d'un très grand nombre de personnes."
    col2:
      reverseMobile: false
      image:
        decorativeOrInformative: false
